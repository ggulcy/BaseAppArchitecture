...
import kotlinx.android.synthetic.main.dialog_fragment2.view.*
...
//        val behavior = BottomSheetBehavior.from(view.rl_bottom_sheet2)
//        behavior.state = BottomSheetBehavior.STATE_EXPANDED
//        behavior.peekHeight = (getDeviceSize(context).second * 0.9).toInt()
        view.rl_bottom_sheet.layoutParams.apply {
            height = (getDeviceSize(context).second * 1).toInt()
        }
